...
#endif
#if defined(RT_ISRF_BACKGROUND) && defined(RT_ISRF_ATTENUATE_COLUMN) // latter flag decides whether we do treecol/sobolev here to get the background intensity
