/* SoA (Structure of Arrays) version of cell_data.h
 * Auto-generated by convert_to_soa.py
 * Original struct fields become per-field arrays.
 * Access pattern: CellP[i].Field -> CellP.Field[i]
 */
...
void copy_particle_between_CellP(cell_soa& dest, int di, cell_soa& src, int si);
void move_particles_CellP(cell_soa& s, int dest, int src, int count);
void MPI_Sendrecv_CellP_fields(cell_soa& src, long src_offset, long count,
                               cell_soa& dest, long dest_offset, long recv_count,
                               int target, int tag);
...
extern struct cell_soa CellP; /* SoA data on local processor */
extern struct cell_soa DomainGasBuf; /* buffer for domain decomposition */
